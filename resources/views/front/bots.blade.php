...
<section class="wide-text">
  <div class="container text-center">
    <h3>Боты функционируют 24/7, поддерживая и оптимизируя процессы без внешнего вмешательства. Выполняют рутинную работу менеджеров, бухгалтеров, технической поддержки.</h3>
  </div>
</section>
...
<section class="works bot-works">
  ...
  <div class="container">
    <h3 class="text-center text-lg-left">Проекты, которые мы запустили</h3>
  </div>
      ...
      <div class="row align-items-end">
        ...
        <div class="col-lg-4" style="overflow-x: hidden;">
          <div class="wow backInRight">
            ...
            <p>Основной целью бота является внеднерение программы лояльности для поощрения трудолюбивых сотрудников компании. Помогает сотруднику вывести бонусные баллы от продаж шин методом сканирования QR-кодов с физических чеков. Также, имеем интеграцию с апи клиента, которая позволяет вести диалог с техподдержкой, оставлять заявки на коммуникацию, уточнять свой статус и баланс по программе лояльности.</p>
            <button class="button more btn-more closed" data-open="Читать полностью" data-close="Скрыть">Читать полностью</button>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="block-more">
        <div class="block-inner">
          ...
          <p>Результат: <br> Рост продаж моторных масел, снижение нагрузки на отдел поддержки, благодаря информативности наполнения бота. Рост мотивации приобретения моторных масел благодаря системе оповещений об акциях и уникальных предложениях.</p>
        </div>
      </div>
