...
<div class="container">
  ...
  <ul class="nav nav-pills nav-tabs" id="pills-tab" role="tablist">
    <li class="nav-item" role="presentation">
      <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">О НАС</a>
    </li>
    <li class="nav-item" role="presentation">
      <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">КАК МЫ РАБОТАЕМ</a>
    </li>
  </ul>
    ...
    <div class="tab-pane fade how-work-blocks" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
      ...
      <div class="row">
        ...
        <div class="col-md-4 item">
          ...
          <div class="text"><span>Встречаем вас, <br> слушаем ваши идеи</span></div>
        </div>

        <div class="col-md-4 item">
          <div class="number">02</div>
          <div class="text"><span>Вместе заполняем бриф <br> и план проекта</span></div>
        </div>

        <div class="col-md-4 item">
          <div class="number">03</div>
          <div class="text"><span>Пишем и утверждаем <br> детальное техзадание</span></div>
        </div>
        ...
        <div class="col-md-4 item">
          ...
          <div class="text"><span>Создаем прототип и <br> разрабатываем дизайн</span></div>
        </div>
        ...
        <div class="col-md-4 item">
          ...
          <div class="text"><span>Остаемся на связи и <br> поддерживаем проект</span></div>
        </div>

        <div class="col-md-4 item">
          <div class="number">09</div>
          <div class="text"><span>Участвуем в жизни проекта, добавляем новые функции и возможности</span></div>
        </div>
      </div>
